...
context 'Windows Account' do
  ...
  # NOTE: this snippet does not work on older Windows builds. The error on Windows 7 is:
  # Method invocation failed because [System.Security.Principal.NTAccount] does _x000D__x000A_</S><S S="Error">not contain a method named 'New'
  ...
  # TODO: logonid
  describe command('cmd %%- /c whoami.exe /user /fo list') do
